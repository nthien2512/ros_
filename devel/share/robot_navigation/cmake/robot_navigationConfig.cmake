...
if("TRUE" STREQUAL "TRUE")
  set(robot_navigation_SOURCE_PREFIX /home/ntdev204/ws_utc/src/robot_navigation)
  set(robot_navigation_DEVEL_PREFIX /home/ntdev204/ws_utc/devel)
  ...
  set(robot_navigation_INSTALL_PREFIX /home/ntdev204/ws_utc/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ntdev204/ws_utc/src/robot_navigation/${idir}'.  ${_report}")
    endif()
